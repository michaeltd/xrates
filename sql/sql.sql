...
CREATE VIEW IF NOT EXISTS XRATES AS
       SELECT CCY_XRATES.DT AS DT,CCY_XRATES_DOUB.CCY AS FROM_CCY,ROUND(CCY_XRATES.VAL/CCY_XRATES_DOUB.VAL,4) AS XRATE,CCY_XRATES.CCY AS TO_CCY
       FROM CCY_XRATES,CCY_XRATES AS CCY_XRATES_DOUB
       WHERE CCY_XRATES.DT = CCY_XRATES_DOUB.DT
       ORDER BY CCY_XRATES.DT,CCY_XRATES.CCY ASC
/* XRATES(DT,FROM_CCY,XRATE,TO_CCY) */;

CREATE VIEW IF NOT EXISTS LAST_XRATES AS
       SELECT CCY_XRATES.DT AS DT,CCY_XRATES_DOUB.CCY AS FROM_CCY,ROUND(CCY_XRATES.VAL/CCY_XRATES_DOUB.VAL,4) AS XRATE,CCY_XRATES.CCY AS TO_CCY
       FROM CCY_XRATES,CCY_XRATES AS CCY_XRATES_DOUB
       WHERE CCY_XRATES.DT = CCY_XRATES_DOUB.DT AND CCY_XRATES.DT = (SELECT MAX(DT) FROM CCY_XRATES)
       ORDER BY CCY_XRATES_DOUB.CCY
